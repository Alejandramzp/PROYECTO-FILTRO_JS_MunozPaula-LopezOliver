        ...
        .then(data => {
            ...
            if (rocket) {
                ...
                <div class="advancedinfo">
                    ...
                    <p><strong>Number:</strong><br><span style="color: white;"> ${rocket.landing_legs.number}</p><br>
                    <p><strong>Material:</strong><br><span style="color: white;"> ${rocket.landing_legs.material}</p><br>
                </div>
                <div class="stages">
